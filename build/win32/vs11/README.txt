...
build/win32/vs11/README.txt file in glib for details where to unpack them.
...
<root>\vs11\<PlatformName>\include\gtk-3.0. This is then from where
...
**:Put the sources of the packages marked with ** in <root>\<package-
    source-tree>, and build with VS11 from there.
