...
build/win32/vs15/README.txt file in glib for details where to unpack them.
...
<root>\vs15\<PlatformName>\include\gtk-3.0. This is then from where
...
**:Put the sources of the packages marked with ** in <root>\<package-
    source-tree>, and build with VS15 from there.
